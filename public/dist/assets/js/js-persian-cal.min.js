...
AMIB.persianCalendar.prototype.showHidePicker = function(b) {
    ...
    if (c = A$(a)) {
        ...
        console.log($('#' + this.inputID).attr('data-body'));
        if ($('#' + this.inputID).attr('data-body') === undefined) {
            console.log('add');
            document.body.appendChild(c);   
        } else {
            console.log('add in ');
            $($('#' + this.inputID).attr('data-body')).append(c);
        }

        this.setMenuPos(c,
            d);
        c.style.zIndex = !lastOpenPDatePicker ? pDatePickerZIndex = 99999999 : ++pDatePickerZIndex;
